    ...
    namespace NeuralNetwork {
        ...
        namespace Layer {
            ...
            void FullyConnected::setFilterSize(T_Size value) {
                assert("No setFilterSize for FULLYCONNECTED layer.");
            }

            void FullyConnected::setPadding(T_Size value) {
                assert("No setPadding for FULLYCONNECTED layer.");
            }

            void FullyConnected::setStride(T_Size value) {
                assert("No setStride for FULLYCONNNECTED layer.");
            }

            void FullyConnected::setWidth(T_Size value) {
                assert("No setWidth for FULLYCONNNECTED layer.");
            }

            void FullyConnected::setHeight(T_Size value) {
                assert("No setHeight for FULLYCONNNECTED layer.");
            }

            void FullyConnected::setDepth(T_Size value) {
                assert("No setDepth for FULLYCONNNECTED layer.");
            }

            void FullyConnected::setNumFilters(T_Size value) {
                assert("No setNumFilters for FULLYCONNECTED layer.");
            }
        }
    }
}
